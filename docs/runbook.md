...
Problem Statement:
KijaniKiosk currently operates with basic infrastructure and limited production-readiness. The goal is to
extend the system into a production-approaching, multi-environment, monitored deployment with
automated CI/CD and environment isolation.
In-Scope Components:
...
- Implementing a Jenkins pipeline with automated staging deploy, smoke tests, and a manual approval
